...
cat <<EOF
  ...
  .tdata	${RELOCATING-0} :
   {
     ${EMIT_TDATA_BOUNDARY+PROVIDE_HIDDEN (${USER_LABEL_PREFIX}__tdata_start = .);}
     ${EMIT_TDATA_BOUNDARY-${RELOCATING+${CREATE_SHLIB-PROVIDE_HIDDEN (${USER_LABEL_PREFIX}__tdata_start = .);}}}
